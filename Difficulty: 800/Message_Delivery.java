//Problem
    ...
    Move from position 𝑝𝑜𝑠
     to position 𝑝𝑜𝑠−1
    .
    A sequence of steps will be considered successful if, during the entire journey, you visit each position 𝑥𝑖
     on the 𝑋
     axis at least once. Note that the initial position 𝑝𝑜𝑠=𝑠
...
public class CarnivalWheel
{
	public static void main(String[] args) {
	    ...
	    while(t-->0){
            ...
            if(pos<=arr[0]){
                System.out.println(arr[n-1]-pos);
                continue;
            }
